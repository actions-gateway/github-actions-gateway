...
const (
	...
	ReasonLimitRangeCPULimit      = apiconditions.ReasonLimitRangeCPULimit
	ReasonNoLimitRangeOverride    = apiconditions.ReasonNoLimitRangeOverride
	ReasonLimitRangesUnreadable   = apiconditions.ReasonLimitRangesUnreadable
)

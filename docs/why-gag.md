...
!!! note "What the current stamps were read against"
    ...
    Every cell above was read on **2026-08-12** against ARC
    `gha-runner-scale-set` **0.14.2** (released 2026-05-22), at commit
    [`9bb16ae`](https://github.com/actions/actions-runner-controller/tree/9bb16ae49d0ce585d8e682aa7e2668a6e832d5d8):
    controller source and chart values, not the documentation. The tag is what

...
<div class="gag-stats" markdown="0">
  ...
  <div class="gag-stat">
    ...
    <span class="gag-stat__label"><strong class="gag-stat__lead">Handling for quota-blocked and evicted jobs</strong> — a job the quota has no room for is never claimed, so it stays queued for a sibling with capacity; anything that slips through is lock-cancelled and re-queued, no manual rerun</span>
  </div>
  <div class="gag-stat">

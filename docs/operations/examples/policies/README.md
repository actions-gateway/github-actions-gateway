...
Complementary policy samples for running github-actions-gateway (GAG) alongside a cluster policy engine.
Full context, the compatibility matrix, and apply instructions are in [../../admission-policies.md](../../admission-policies.md).
...
Each file is commented with what it does, what to edit for your cluster, and how to roll it out safely (audit/dry-run first).
Treat them as starting points — adapt the policy names and install-namespace references to your environment.

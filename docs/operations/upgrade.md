...
> **Current release — `v1.8.0`** (chart version = release tag without the leading `v`).
> Pin `--version 1.8.0`; copy the image digests from the [release notes](https://github.com/actions-gateway/github-actions-gateway/releases/tag/v1.8.0) and verify the chart/image signatures before installing (see [release.md § Verify the publish](release.md#3-verify-the-publish)).

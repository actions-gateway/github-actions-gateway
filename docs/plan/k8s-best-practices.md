...
| # | Sev | Finding | Location | Fix |
|---|---|---|---|---|
| B1 | ✅ | ~~Manager ClusterRole grants `rbac.authorization.k8s.io: escalate`.~~ Dropped 2026-06-01 from the kubebuilder marker on `actionsgateway_controller.go`; `bind` retained. | [actionsgateway_controller.go:10](../../cmd/gmc/internal/controller/actionsgateway_controller.go), [role.yaml:130](../../cmd/gmc/config/rbac/role.yaml) | — |

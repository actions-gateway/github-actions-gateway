...
- **Cover deletion, not only terminal phase.** Classic's branch fires on
  ...
  path appears to reach no recovery at all. **Measured 2026-07-27 (Q421) and
  confirmed on both tiers** — a drained worker pod publishes no terminal phase

...
| Inline `TP=…` compound-throttle recipe in the Testing throttle bullet | [Q347](../STATUS.md#Q347) (go-throttle hook rewrites compound `-race` forms instead of blocking) lands | Drop the recipe; the hook's own message carries the corrected command |

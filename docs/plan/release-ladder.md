...
| **1.9** | The Rule 4b overlap: `v2` served beside `v2beta1`, storage still `v2beta1`. The admission reject plus pre-upgrade check from Q1085, then [v2-ga.md](v2-ga.md) Phase 2 | [release-1.9.md](release-1.9.md) |

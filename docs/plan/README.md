...
| [v2-api-gap-analysis.md](v2-api-gap-analysis.md) | Full v1↔v2 gap analysis (API surface + controller/webhook behavior): what v1 does that v2 doesn't, with per-gap evidence; distinguishes genuine gaps from intentional design differences | ⓘ Review — 8 gaps found: the noProxyCIDRs admission gap was fixed same-day (#641), its GHES residual closed by the Q322 follow-up, and Q323/Q326/Q327/Q328 since fixed; still open: [Q324](../STATUS.md#Q324), [Q325](../STATUS.md#Q325), [Q329](../STATUS.md#Q329). Parity/intentional differences recorded so future audits don't re-litigate them |

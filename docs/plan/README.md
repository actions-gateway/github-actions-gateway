...
| [structural-debt-audit-2026-07.md](structural-debt-audit-2026-07.md) | Codebase-wide structural debt audit (2026-07-20): god functions, oversized files, version-boundary duplication, test-double sprawl, script sprawl — with the evidence behind each Queue row, plus deliberate non-findings and unverified leads | ❌ Open — filed 2026-07-20, no remediation started ([Q361](../STATUS.md#Q361)–[Q370](../STATUS.md#Q370)) |

...
| [q300-gmc-kindnet-e2e-flake.md](q300-gmc-kindnet-e2e-flake.md) | Systemic kindnet `e2e / e2e` leg flakiness: different unrelated specs fail run to run (webhook `context deadline exceeded`, job-delivery 0-worker stalls, egress→GitHub timeouts) — GMC/AGC control-plane resource starvation under CI load suspected | ❌ Open — investigation in progress ([Q300](../STATUS.md#Q300)) |

...
| [kata-on-gke.md](kata-on-gke.md) | Kata Containers on GKE: spike + reference architecture for unprivileged kind-in-runner CI (Q226 spike ✅ GO, live-validated) | ❌ Open — reference arch delivered; CI rollout tracked as [Q283](../STATUS.md#Q283) |

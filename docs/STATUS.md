...
| <a id="Q223"></a>Q223 | [Worker scale-up rate limit (anti-stampede)](design/appendix-g-future-enhancements.md#g11-worker-scale-up-rate-limiting-anti-stampede) | `infra` | M | A report of simultaneous cold-starts stampeding a shared dependency or cloud/control-plane API beyond what P2P (Q211), the worker-quota ceiling, and workflow `concurrency:` cover. Opt-in/default-off; distinct from proxy rate-limit (G.2/Q19). |

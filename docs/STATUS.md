...
|---|---|---|---|---|---|
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (validation done)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Validated end-to-end on rc.3: control plane, creds, Q229 DNS, registration, job→worker pod→GitHub. Default works via injection (Q235); C2 GAG_RUNNER routing landed. Remaining: turn on production CI live (flip GAG_RUNNER + scale up, re-validate). |

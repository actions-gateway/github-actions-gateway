...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Turn-up 2026-07-01 (rc.6): every CI job green individually on gag-ci; Q246/Q247 hold. Concurrent-matrix recycle-under-burst wedge (Q259, AGC 422→~1 worker) code-fixed; re-route the matrix to confirm green next turn-up. Not capacity ([Q248](#Q248)). |
...
| <a id="Q242"></a>Q242 | [Implement G.1 proxy destination allowlist](plan/q242-g1-proxy-destination-allowlist.md) | `security` `infra` | ▶ | L | Impl merged #460–#464. Dogfood turn-up 2026-07-01 (rc.6): jobs green individually; concurrent green pending live re-validation of the Q259 recycle-under-burst fix. Deliverable 7 = [Q224](#Q224); FQDN split = [Q245](#Q245). v2beta1 blocker. |

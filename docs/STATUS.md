...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | **Option E committed.** P0/P1/P2 done (`scaleset/` client+fake). **P3 in progress, default-Classic:** (a) DONE — `acquisitionProtocol` field (enum/immutable/CEL) + GMC label-uniqueness webhook; (b) listener + (c) worker+twin next. |

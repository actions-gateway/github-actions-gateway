...
| <a id="Q260"></a>Q260 | [AGC duplicate job-acquisition wedges concurrent burst](plan/gke-dogfood.md) | `infra` | ▶ | M | planID dedup + #512 claim-linger EFFECTIVE (0 collisions, re-route #4). #513 completejob-abandon LIVE-TESTED ineffective — returns OK but leaves job in_progress forever; keep flag OFF. Blocker=GitHub fan-out accounting. Blocks [Q224](#Q224). |

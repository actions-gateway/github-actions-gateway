...
| <a id="Q266"></a>Q266 | [Fan-out loser slot-stranding collapses the pool under sustained burst](../cmd/agc/internal/listener/goroutine.go) | `bug` `infra` | ▶ | M | Fix landed offline: defer deduped-loser recycle until its winner concludes (reuse #512 claim registry) — loser holds slot, frees worker reservation, 16-min stuck-winner fallback. Regression test holds vs collapse. Live re-benchmark = separate task. |
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Re-route #5: Q260 accounting RESOLVED. Q265 re-route #6: NO completion-tax wall. Loser-slot-stranding recycle seam FIXED offline ([Q266](#Q266)); full-matrix green needs a live re-benchmark (post-Q266) + worker capacity ([Q248](#Q248), SSD-bound). |

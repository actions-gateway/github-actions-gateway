...
| <a id="Q277"></a>Q277 | [Switch dogfood v2 CRD install to apply-render](plan/gke-dogfood.md) | `infra` | 🔲 | S | scripts/dogfood/setup.sh + plan/gke-dogfood.md still `helm upgrade --install` the v2 CRD chart; Q74's v2beta1 graduation pushed it >1 MiB release-Secret limit so it now fails on post-Q74 tags. Switch both to apply-render per Q276. |
---

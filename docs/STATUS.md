...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | 🔲 | L | Option E spike DONE: verdict VIABLE — official actions/scaleset Go client exists; costs=worker handoff rework, single-label runs-on, GHES≥3.9. Execute (P1 probe→flag→cutover) only if [Q260](#Q260) re-route #5 rules Option A infeasible. |
---

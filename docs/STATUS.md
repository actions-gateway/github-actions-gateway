...
| <a id="Q129"></a>Q129 | [Public GitHub Pages website](plan/website.md) | `docs` `infra` | ✅ | L | [Public site](plan/website.md) launched 2026-06-16: Pages enabled + deployed; landing/banner show the v1.0.0 GA install, keep the Q99 capacity caveat. Cross-tree link reconcile → [Q52](#Q52). |

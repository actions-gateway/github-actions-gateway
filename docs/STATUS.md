...
| <a id="Q71"></a>Q71 | Live-validate runner 2.334.0 registration (Tier C) | `tests` | 🔲 | S | Runner bumped 2.327.1→2.334.0 (#137); `runnerVersion` is a contract GitHub validates at session creation. Unit + Tier-A/B pass, Tier-C is CI-skipped. Run `E2E_GMC_TenantProvisioning` with real App creds to confirm GitHub accepts 2.334.0. |

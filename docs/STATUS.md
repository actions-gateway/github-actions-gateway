...
|---|---|---|---|---|---|
| <a id="Q134"></a>Q134 | Flake: e2e "no session registered" 180s timeout (WorkerPodAdmitted / SessionRegistered) | `tests` `bug` `1.0-gate` | 🔲 | S | #231 bounded control-plane calls; recurred on main 2026-06-15 (run 27529447832), timeline rules out AGC startup. Added DumpAGCSessionDiagnostics (failure-gated, 3 session specs) to root-cause next recurrence: createSession contention vs Q137. |

...
| <a id="Q196"></a>Q196 | [Credentials discriminated-union shape](design/appendix-h-v2-api-decomposition.md#h15-other-breaking-changes-worth-batching) | `infra` `security` | S | v2beta1 is the last free breaking change: decide whether to nest githubAppRef under a discriminated `spec.credentials` parent (clean slot for a future workloadIdentity KMS/HSM signer, no in-cluster PEM) vs a flat sibling. Pairs with Q74; see §H.15. |

...
| <a id="Q145"></a>Q145 | Optional apiserver-CIDR allowlist for AGC egress | `security` | 🔲 | S | Q127 item 7 follow-up: AGC NetworkPolicy allows any-dest egress on 443/6443 (apiserver post-DNAT IP unpredictable). Add an optional operator apiserver-CIDR allowlist to scope it; residual in [05-security §5.2](design/05-security.md). |

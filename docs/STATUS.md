...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | rc.4 turn-on validated; toolchain unblocked (Q239); vendor/tidy egress via Athens (Q244). Run `scripts/dogfood/start.sh` + validate green CI; blockers cleared: Q246 (Q61 cache race, fixed) + [Q247](#Q247) (fixed). On-demand. |

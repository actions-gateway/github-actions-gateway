...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | **Option E committed.** P0/P1/P2 done. **P3, default-Classic:** (a) field+webhook, (b) `scalesetlistener`+fan-out-free twin, (c) worker `run.sh` mode + provisioner JIT staging — DONE; (d) RunnerSet reconciler wiring + envtest next. |

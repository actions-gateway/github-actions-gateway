...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | **Option E committed.** P0/P1/P2 done. **P3 in progress, default-Classic:** (a) DONE field+webhook; (b) DONE `scalesetlistener` engine + fan-out-free acceptance twin (not yet reconciler-wired); (c) reconciler wiring + worker JIT path next. |

...
|---|---|---|---|---|---|
| <a id="Q35"></a>Q35 | [K8s audit — §F Observability & operational](plan/k8s-best-practices.md#f-observability--operational-) | `infra` `1.0-gate` | 🔲 | M | 🟡 F1/F5/F6 done (JSON unify via slog→zap bridge; AGC zap flag; health probes). Left: F2 no OTel tracing; F3/F4 GMC leader-election grace + tuning flags. See [§F](plan/k8s-best-practices.md#f-observability--operational-). |

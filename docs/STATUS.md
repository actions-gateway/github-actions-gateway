...
| <a id="Q177"></a>Q177 | v2 operator-doc coverage (getting-started, onboarding, securityProfile) | `docs` | 🔲 | S | v2 (M1–M5) shipped but operator docs lag: add a v2 path to getting-started + the actions-gateway-crds-v2 chart prereq; a multi-gateway onboarding section in tenant-onboarding; and "v2: namespace label" notes where securityProfile appears as a spec field. |

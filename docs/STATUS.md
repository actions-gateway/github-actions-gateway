...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | **Option E committed. P3 DONE** (default-Classic): reconciler branches on `acquisitionProtocol==ScaleSet` — one `scalesetlistener` session per set, clean teardown; lifecycle envtest. **P4 next:** live dogfood ([Q224](#Q224) gate). |

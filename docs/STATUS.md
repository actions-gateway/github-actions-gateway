...
| <a id="Q260"></a>Q260 | [AGC duplicate job-acquisition wedges concurrent burst](plan/gke-dogfood.md) | `infra` | ▶ | M | planID dedup EFFECTIVE 2026-07-04. Redelivery pod-collision residual CODE-COMPLETE (this PR): claim lingers completedPodTTL until pod GC → late redelivery deduped, no `create Pod` collision. Awaits capacity + re-route #4. Blocks [Q224](#Q224). |

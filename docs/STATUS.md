...
| Release 1.0 | `milestone` | ⚠️ | Bar = installable + multi-tenant + trustworthy; load test ([Q13](#Q13)) & gVisor ([Q15](#Q15)) deferred post-1.0. Bucket A + Q12 proven 2026-06-12; publish pipeline proven live via v1.0.0-rc.1 2026-06-15 ([Q98](#Q98)); Helm is the sole install path (Q142, pre-GA); remaining: GA promote — [plan](plan/release-1.0.md) |

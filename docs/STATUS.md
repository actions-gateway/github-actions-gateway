...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | 🔲 | L | Option E spike + probes DONE: viable — all protocol unknowns settled; U6/U7/U8 researched w/ recs in plan §5a (own client, v2 acquisitionProtocol field, classic deprecation path). Execute only if [Q260](#Q260) #5 kills Option A. |
---

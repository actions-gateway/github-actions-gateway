...
| <a id="Q273"></a>Q273 | [Make v2 the front door + exemplary v1→v2 migration](plan/v1-classic-sunset-review.md) | `docs` `infra` | 🔲 | M | **v2 = the front door; make v1→v2 migration exemplary (adoption trust signal, review §6.2).** Route docs+onboarding+templates to v2, deprecate-v1 banners (now); polish gag-migrate+guide. Full 'v2-only' gated on v2beta1 ([Q74](#Q74)). |

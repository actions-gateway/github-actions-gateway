...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | 🔲 | L | Option E spike + wire probe DONE: viable — App auth chain live-confirmed (org+repo); broker/rest backend AUTO-ASSIGNS jobs (no acquirejobs; X-ScaleSetMaxCapacity gates). Execute (P2+) only if [Q260](#Q260) re-route #5 rules Option A infeasible. |
---

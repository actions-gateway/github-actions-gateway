...
| <a id="Q267"></a>Q267 | [Broker-credential recycle seam: post-recycle token-exchange 400 exits the listener](../cmd/agc/internal/listener/goroutine.go) | `bug` `infra` | ▶ | M | Post-recycle broker token 400 `Registration-not-found` (Q259/Q114) was fatal → listeners churn records, online pool ~0 at wide maxListeners. Fix: bounded jittered retry, no re-register. Code-complete + offline repro; live reconfirm pending. |
...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Re-route #7: [Q248](#Q248) SSD ceiling gone; [Q266](#Q266) seam fixed live. NOT green — residual online-session/broker-credential recycle churn now addressed code-side by [Q267](#Q267); live wide-pool re-benchmark + clean-namespace pending. |
...
| <a id="Q242"></a>Q242 | [Implement G.1 proxy destination allowlist](plan/q242-g1-proxy-destination-allowlist.md) | `security` `infra` | ▶ | L | Impl merged #460–#464; accounting UNBLOCKED (Option A #5). Capacity/SSD residual CLEARED (#7 pd-standard, [Q248](#Q248)); concurrent-green now gated on the online-session seam ([Q224](#Q224)). FQDN [Q245](#Q245). v2beta1 blocker. |

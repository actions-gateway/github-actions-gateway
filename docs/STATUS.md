...
| <a id="Q74"></a>Q74 | [v2alpha1→v2beta1 graduation: conversion webhook](plan/k8s-best-practices.md#d-crd-design-polish-) | `infra` | 🔲 | S | **CRITICAL PATH — the 'v2 is the front door' gate** ([sunset review](plan/v1-classic-sunset-review.md)). Live blockers: Q224 + Q242 (unblock via [Q264](#Q264) scale-set clean-green) + Q243 (egress-IP validation). Distinct from the M5 gag-migrate tool. |
| <a id="Q271"></a>Q271 | [Make v2 the front door + exemplary v1→v2 migration](plan/v1-classic-sunset-review.md) | `docs` `infra` | 🔲 | M | **v2 = the front door; make v1→v2 migration exemplary (adoption trust signal, review §6.2).** Route docs+onboarding+templates to v2, deprecate-v1 banners (now); polish gag-migrate+guide. Full 'v2-only' gated on v2beta1 ([Q74](#Q74)). |

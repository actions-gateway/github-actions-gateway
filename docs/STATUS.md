...
| <a id="Q172"></a>Q172 | [v2 optional templateRef (default ClusterRunnerTemplate)](plan/v2-api.md#deferred-out-of-the-critical-path) | `infra` | 🔲 | M | Relax templateRef required→optional: resolve unset via ActionsGateway.defaultTemplateRef → a default-marked ClusterRunnerTemplate (StorageClass pattern: ≤1 default, fail-closed TemplateNotFound). Parallels Q168. |

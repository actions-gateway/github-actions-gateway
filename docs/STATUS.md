...
| <a id="Q130"></a>Q130 | [Platform-owned ResourceQuota — remove tenant-authored quota](plan/platform-owned-quota.md) | `infra` `security` `1.0-gate` | 🔲 | L | [Platform-owned ResourceQuota](plan/platform-owned-quota.md): drop tenant-authored spec.namespaceQuota — platform owns it, GMC drops quota-write RBAC. Tenant-set quota is no real cap and fights GitOps. Breaking CRD, pre-1.0; see [Q122](#Q122). |

...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🚫 | M | Turn-up 2026-07-01 (rc.6): every CI job green individually on gag-ci; Q246 holds (7340-CIDR NP, no asset timeout); Q247 holds for run jobs. Concurrent full matrix blocked on [Q259](#Q259) (AGC recycle-under-burst), not capacity ([Q248](#Q248)). |
| <a id="Q259"></a>Q259 | [AGC agent-pool wedges under concurrent job burst](plan/gke-dogfood.md) | `infra` `bug` | 🔲 | M | Live 2026-07-01: bursting the CI matrix serializes gag-ci to ~1 worker (ample node room) — AGC can't recycle runners (GitHub 422) so listeners aren't replenished → queued jobs time out/cancel. Blocks [Q224](#Q224); not capacity ([Q248](#Q248)). |
...
| <a id="Q242"></a>Q242 | [Implement G.1 proxy destination allowlist](plan/q242-g1-proxy-destination-allowlist.md) | `security` `infra` | ▶ | L | Impl merged #460–#464. Dogfood turn-up 2026-07-01 (rc.6): jobs green individually, concurrent green blocked on [Q259](#Q259). Deliverable 7 = [Q224](#Q224); FQDN split = [Q245](#Q245). v2beta1 blocker. |

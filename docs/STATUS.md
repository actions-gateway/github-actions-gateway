...
| <a id="Q246"></a>Q246 | [Worker egress to GitHub release CDN (objects.githubusercontent.com)](plan/q242-g1-proxy-destination-allowlist.md) | `security` `infra` | 🔲 | S | Workers (direct egress) can't reach `objects.githubusercontent.com` (release-asset CDN); a CDN CIDR allowlist is a footgun, so bake assets into the runner image (Athens-style, [Q244](#Q244)). shellcheck baked; setup-go remains. Blocks [Q224](#Q224). |

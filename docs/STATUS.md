...
| Six-layer docs audit | `docs` | ✅ | All six layers audited and fixed (0 broken links/anchors); follow-ons tracked as [Q51](#Q51) (Q52 done) — [plan](plan/docs-six-layer-audit.md) |

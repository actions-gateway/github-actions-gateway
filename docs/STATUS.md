...
|---|---|---|---|---|---|
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🚫 | M | Live rc.4 turn-on validated: routing→gag-ci, listener+workers autoscale, Q235 injection (job ran→GitHub). Toolchain unblocked (Q239 done, #457). Full green now blocked on [Q242](#Q242) egress half (vendor-check/tidy-check). On-demand. |

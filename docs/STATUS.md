...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | ScaleSet P4 (2026-07-05): fan-out starvation ELIMINATED by construction — all 7 assigned+ran+concluded (vs classic 2/7), 0 dedup/collision. Q269 WORKER_MODE leak fixed (#542); clean-green pending re-run + capacity ([Q248](#Q248)). Do not close. |
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | P4 RAN (2026-07-05): fan-out ELIMINATED by construction (7/7 vs classic 2/7); U3 pod-core settled. Q269 fixed (#542), Q270 409/wedge hardened; clean-green pending re-run + capacity; P5 (default flip/retire classic) gated on it. §6-P4. |

...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | planID dedup live-validated effective 2026-07-04: burst Secret-collapse gone, dedup fires, 2 jobs green. Full green still blocked — spot preemption ([Q248](#Q248)) → 600s/15-min timeouts + a late-redelivery pod-collision ([Q260](#Q260)). |
| <a id="Q260"></a>Q260 | [AGC duplicate job-acquisition wedges concurrent burst](plan/gke-dogfood.md) | `infra` | ▶ | M | planID dedup (post-acquire) live-validated EFFECTIVE 2026-07-04: 0 Secret collisions, collapse gone, 2 jobs green. Open for residual — spot-capacity + late-redelivery pod-collision (release claim post-GC). Blocks [Q224](#Q224). |

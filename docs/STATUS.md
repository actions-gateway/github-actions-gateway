...
| <a id="Q266"></a>Q266 | [Fan-out loser slot-stranding collapses the pool under sustained burst](../cmd/agc/internal/listener/goroutine.go) | `bug` `infra` | ✅ | M | Fix live-confirmed (#7): loser-slot-stranding seam GONE — 0 fatal deregister exits (Q265: 41/38), losers park, Option A+dedup fire. Residual collapse = SEPARATE online-session/broker-credential recycle seam → [Q224](#Q224). |
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Re-route #7: [Q248](#Q248) SSD ceiling gone (pd-standard, no quota bump); [Q266](#Q266) seam confirmed fixed live. NOT green — residual = online-session/broker-credential recycle churn (Q259/Q114) + un-cleanable records; not capacity/tax. |

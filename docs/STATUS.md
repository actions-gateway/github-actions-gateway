...
| <a id="Q371"></a>Q371 | [Add nolintlint + a ratcheted funlen gate](plan/structural-debt-audit-2026-07.md) | `infra` | 🔲 | S | Config-only. `nolintlint` (allow-unused:false) catches inert suppressions like the `nolint:gocyclo` Q367 removed. Start `funlen` above the worst survivor, ratchet down; Q367 shipped so it can now land. §Prevention. |

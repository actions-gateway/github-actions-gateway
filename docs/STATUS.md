...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | ✅ | M | ScaleSet clean-green ACHIEVED 2026-07-05: re-run on main@2025557 (Q269 #542 + Q270 #544) → ALL 7 GAG jobs GREEN on gag-scaleset3 (7/7 assigned+ran+concluded, 0 dedup/wedge); unit-test+coverage green (WORKER_MODE fix holds). §6-P4. CLOSED. |
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | P4 CLEAN-GREEN ACHIEVED 2026-07-05 (re-run, main@2025557): all 7 GAG jobs GREEN on ScaleSet (0 dedup/wedge); Q269 #542 + Q270 #544 hold. Fan-out eliminated by construction CONFIRMED. [Q224](#Q224) CLOSED. P5 (default flip) UNBLOCKED. §6-P4. |
...
| <a id="Q270"></a>Q270 | [ScaleSet listener: generatejitconfig 409 mislabel + no-backoff cursor wedge](../scaleset/errors.go) | `bug` `infra` | ✅ | S | FIXED: 409→neutral `ConflictError`, translated per-call (`SessionConflictError` vs new `RunnerNameConflictError`); listener retries generatejitconfig under a fresh name (bounded/backed-off), skips a persistent conflict (no cursor wedge). §6-P4. |
| <a id="Q242"></a>Q242 | [Implement G.1 proxy destination allowlist](plan/q242-g1-proxy-destination-allowlist.md) | `security` `infra` | ▶ | L | Impl merged #460–#464. Concurrent-green ACHIEVED via ScaleSet clean-green ([Q264](#Q264) P4, 2026-07-05: 7/7 GAG jobs GREEN, 0 dedup/wedge). FQDN [Q245](#Q245). v2beta1 blocker cleared; [Q74](#Q74) + [Q243](#Q243) egress-IP remain. |

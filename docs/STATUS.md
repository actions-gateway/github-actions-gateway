...
| 6 | [M3/M4 kind end-to-end validation](plan/milestone-3.md) | `milestone` | 🔲 | M | **Unblocked** — 5b shipped (AGC pod now governed by a single NP). With PR #59 fixes, JIT config plumbing (5a), and 5b in place, the live-cluster path should reach worker completion. Next live-cluster dry-run will tell. |

...
| <a id="Q162"></a>Q162 | [Confirm AGC listener lifecycle for v2 `maxListeners` default](design/appendix-h-v2-api-decomposition.md#h15-other-breaking-changes-worth-batching) | `infra` | S | Rides Q149 (v2 types). Demand-spawned + idle-shutdown → default 10 (match design); always-on → default 1. Q148/Q152 lineage. |

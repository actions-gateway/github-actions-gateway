...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | 🔲 | L | Option E spike + probes DONE: viable — all protocol unknowns settled (auto-assign w/ capacity gate, session replay, real runner ran a job E2E, dead-runner ≈9.5min). Proxy/pod integration left (P4). Execute only if [Q260](#Q260) #5 kills Option A. |
---

...
| <a id="Q264"></a>Q264 | [Migrate AGC acquisition to the runner-scale-set protocol](plan/q264-scale-set-protocol.md) | `infra` | ▶ | L | **Option E committed.** P0/P1 done; **P2 DONE**: `scaleset/` client + `scalesettest` fake (81.6% cov) — two-hop auth, admin-JWT refresh, capacity poll, both acquire paths, replay/claim-once. **P3 next:** AGC wiring behind `acquisitionProtocol`. |

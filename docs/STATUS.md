...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Re-route #4 (2026-07-04): capacity + collisions FIXED (3 non-preempted nodes, 0 collisions). Still NOT green — blocker=GitHub fan-out completion accounting ([Q260](#Q260)); Option A coded, default-off, pending live re-route #5. |
| <a id="Q260"></a>Q260 | [AGC fan-out completion accounting wedges concurrent burst](plan/q260-fanout-completion-reconciliation.md) | `infra` | ▶ | M | planID dedup + #512 linger EFFECTIVE. Option A (winner fans completejob to all deduped siblings on completion) IMPLEMENTED behind default-off `AGC_FANOUT_COMPLETION`; offline gate green; awaiting live re-route #5. Blocks [Q224](#Q224). |

...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI green](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Re-route #8 (clean ns, maxListeners 48): [Q267](#Q267) confirmed — pool HOLDS, 0 churn. Still NOT green (2/7): residual = GitHub fan-out distinct-delivery starvation ([Q264](#Q264)/Option E territory), NOT recycle/capacity/tax. Do not close. |

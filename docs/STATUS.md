...
| <a id="Q224"></a>Q224 | [GKE dogfood: route production CI (green CI blocked)](plan/gke-dogfood.md) | `milestone` `infra` | 🔲 | M | Jobs green individually on gag-ci; concurrent matrix still wedges. Turn-up 2026-07-03 deployed the Q259 fix — collapse persists via duplicate job-acquisition ([Q260](#Q260)), not the recycle Q259 fixed. Not capacity ([Q248](#Q248)). |
| <a id="Q260"></a>Q260 | [AGC duplicate job-acquisition wedges concurrent burst](plan/gke-dogfood.md) | `infra` | 🔲 | M | Turn-up 2026-07-03: with Q259 fix deployed (`agc:e2e-2310a31`) the concurrent matrix still collapses to ~1 worker — 5 agents provision the *same* job (Secret 'already exists'), burning runner slots. Distinct from Q259 recycle. Blocks [Q224](#Q224). |

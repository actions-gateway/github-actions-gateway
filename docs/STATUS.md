...
| <a id="Q74"></a>Q74 | [v2alpha1→v2beta1 graduation: conversion webhook](plan/q74-v2beta1-conversion-webhook.md) | `infra` | 🚫 | S | **'v2 front door' gate — BLOCKED on [Q264](#Q264) P5.** Per U7/U8 the ScaleSet-only v2beta1 cut is the last rung (after P5's default-flip + Classic-deprecation window) & strips `acquisitionProtocol`+`maxListeners`. Q224/Q242 cleared, Q243 soft. |

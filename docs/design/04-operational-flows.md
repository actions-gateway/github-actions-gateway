...
| Capacity (Q405) | this set's non-terminal worker pods, while its capacity gate is declining — no room for one more | no bound (gate `Off`, nothing declining, or nothing readable) |

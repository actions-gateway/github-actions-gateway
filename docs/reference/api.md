...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#condition-v1-meta) array_ | Conditions are the observed conditions of the gateway. Known types: Ready, AGCAvailable, CredentialUnavailable, Degraded, EgressUnattributed, RunnerSetsDegraded. |  | Optional: \{\} |
...
| `requests` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ | Requests are the recommended resource requests (cpu, memory), derived from the p95 of observed per-job usage peaks and rounded up to coarse increments (sizing is bucket-granular, not exact). |  | Optional: \{\} |
| `limits` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ | Limits are the recommended resource limits. Memory only, at the observed maximum peak plus OOM headroom; no CPU limit is ever recommended. |  | Optional: \{\} |
| `observedPeak` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ | ObservedPeak is the highest per-job usage peak (cpu, memory) observed in the window — the input to the recommended memory limit. |  | Optional: \{\} |
| `observedP95` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ | ObservedP95 is the 95th percentile of per-job usage peaks (cpu, memory), bucket-interpolated — the input to the recommended requests. |  | Optional: \{\} |
...
| `windowStartTime` _[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#time-v1-meta)_ | WindowStartTime is when this container's observation window began (first sampled job, surviving AGC restarts via the re-seed). |  | Optional: \{\} |
...
| `resources` _[ResourceRequirements](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcerequirements-v1-core)_ | Resources are the proxy container's resource requirements. |  | Optional: \{\} |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#condition-v1-meta) array_ | Conditions are the observed conditions of the proxy pool. Known types: Ready, Degraded, ProxyQuotaPressure, ProxyQuotaExceeded, EgressRulesStale (Q320). |  | Optional: \{\} |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#condition-v1-meta) array_ | Conditions are the observed conditions of the template. No condition types are populated today: the templates are pure data with no reconciler; the field exists for the uniform v2 status contract. |  | Optional: \{\} |
| `observedGeneration` _integer_ | ObservedGeneration is the .metadata.generation the most recent reconcile acted on. |  | Optional: \{\} |
...
| `minRequests` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ | MinRequests / MaxRequests clamp every derived cpu/memory request (and the limits that track them) within an operator-set floor/ceiling, bounding how far a skewed usage history can push the derived values. Keys other than cpu and memory are ignored. |  | Optional: \{\} |
| `maxRequests` _[ResourceList](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcelist-v1-core)_ |  |  | Optional: \{\} |

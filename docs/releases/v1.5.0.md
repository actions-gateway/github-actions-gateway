...
`rc.1` validated and was then superseded by eight further gating rows; `rc.2` was tagged at a stale commit and could not be corrected, because a published immutable Release locks its tag ([postmortem](https://github.com/actions-gateway/github-actions-gateway/blob/main/docs/postmortems/2026-08-15-rc2-tagged-a-stale-commit.md)).

<details>
<summary><b>The five legs, and what the artifact checks discriminate</b></summary>

Run against the signed release artifacts rather than a build ([run](https://github.com/actions-gateway/github-actions-gateway/actions/runs/31901350050)):

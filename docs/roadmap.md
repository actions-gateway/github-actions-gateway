...
- **[Retiring `v1alpha1`, `v2alpha1`, `v2beta1`, and the classic acquisition protocol](operations/v1alpha1-deprecation.md)** <!-- q:Q273,Q1085 --> Committed, but not yet started. **`v2.0.0`** removes all four, plus the deprecated `CiliumFQDN`/`CalicoFQDN` egress aliases the two v2 versions define. `v1.3.0` announced the first three; `v2beta1` was added 2026-09-08 and is superseded by the GA `v2` version.

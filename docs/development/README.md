...
| [documentation-standards.md](documentation-standards.md) | How we write and maintain docs — style for scannability, copy-paste-safe code blocks, conventions (acronyms, terminology, diagrams, no `CLAUDE.md` links), and the maintenance/upkeep rules. Read before writing or restructuring a doc. |

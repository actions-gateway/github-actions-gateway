...
| [api-review.md](api-review.md) | The pre-release API review — what counts as API, how to enumerate what a release publishes for the first time, and the checklist to apply to each addition. Read in release pre-flight, before tagging. |

...
#
#   scripts/manifest/sync-chart-rbac.sh            # write the chart rules fragment (make chart-rbac)
#   scripts/manifest/sync-chart-rbac.sh --check    # fail if the chart fragment is stale (make chart-rbac-check)
#

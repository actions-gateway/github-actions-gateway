...
#
#   scripts/manifest/sync-chart-webhook.sh            # write the chart webhook template (make chart-webhook)
#   scripts/manifest/sync-chart-webhook.sh --check    # fail if the chart copy is stale (make chart-webhook-check)
#

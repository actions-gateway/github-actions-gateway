...
usage() {
	cat <<'EOF'
Usage: scripts/dependabot-rebase-stale.sh [--dry-run] [PR_NUMBER ...]
       scripts/dependabot-rebase-stale.sh --list
       scripts/dependabot-rebase-stale.sh --bumps BASE_GO_MOD TIP_GO_MOD

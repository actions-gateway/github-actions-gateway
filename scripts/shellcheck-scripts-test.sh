#!/usr/bin/env bash
#
# Unit tests for the file-selection helpers in scripts/shellcheck-scripts.sh
...
# shellcheck source=scripts/shellcheck-scripts.sh
source "$REPO_ROOT/scripts/shellcheck-scripts.sh"
...
failing_candidates() {
	printf 'scripts/shellcheck-scripts.sh\n'
	return 3
}
rc=0
(

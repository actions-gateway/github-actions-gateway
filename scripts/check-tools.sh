...
#
# Usage:
#   scripts/check-tools.sh              # report all tiers; exit nonzero if a
#                                       # REQUIRED tool is missing
#   scripts/check-tools.sh --required   # check only the required tier
#   scripts/check-tools.sh --fix        # offer to run the install command for
#                                       # each missing tool (interactive)
#   scripts/check-tools.sh go kubectl   # check only the named tools
#

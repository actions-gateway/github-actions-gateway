#!/usr/bin/env bash
#
# Unit tests for the instrument parsers in scripts/validate-throttle.sh (Q447):
...
# shellcheck source=scripts/validate-throttle.sh
source "$REPO_ROOT/scripts/validate-throttle.sh"

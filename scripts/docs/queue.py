...
def cmd_next(args):
    ...
    if args.title:
        ...
        return 0
    # The open-question split, carried through the pick prompt: a session handed
    # a row that ends in a choice either guesses at the decision or stalls asking
    # for it, and most of these need neither.

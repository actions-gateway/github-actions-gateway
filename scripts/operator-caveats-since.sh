...
# SEEN them.
#
#   scripts/operator-caveats-since.sh            # since the latest tag
#   scripts/operator-caveats-since.sh v1.2.0     # since an explicit ref
#   scripts/operator-caveats-since.sh --quiet    # exit 0 if anything changed, 1 if not
set -euo pipefail

#!/usr/bin/env bash
#
# Unit tests for scripts/e2e-github-cleanup.sh's runner filter (Q511).
#
...
# shellcheck source=scripts/e2e-github-cleanup.sh
source "$REPO_ROOT/scripts/e2e-github-cleanup.sh"

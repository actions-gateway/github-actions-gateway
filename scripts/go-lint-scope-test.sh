...
# shellcheck source=scripts/go-lint.sh
source "$REPO_ROOT/scripts/go-lint.sh"
...
expect_scope trigger-self 'scripts/go-lint.sh' 'full scripts/go-lint.sh'
expect_scope trigger-throttle 'scripts/local-throttle.sh' 'full scripts/local-throttle.sh'

...
var _ = Describe("E2E_GMC_Resilience", Ordered, func() {
	...
	It("E2E_GMC_GMCRestartPreservesState: GMC restart does not re-provision existing resources", func() {
		...
		Expect(utils.ResourceExists("deployment", tenantNS, "actions-gateway-agc")).To(BeTrue())

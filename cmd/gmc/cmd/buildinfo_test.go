...
// TestRegisterBuildInfo asserts the GMC registers actions_gateway_build_info as
// a constant-1 gauge carrying the component and stamped version (Q318).
func TestRegisterBuildInfo(t *testing.T) {
	reg := prometheus.NewRegistry()
	registerBuildInfo(reg, "gmc", "v1.2.3")
...
actions_gateway_build_info{component="gmc",version="v1.2.3"} 1
`

...
- New near-term or long-term work → add to the backlog in priority order, which until Q889 phase 6 means **both** `docs/STATUS.md` and a `docs/queue/QNNN.md` item; `queue-drift-check` fails if you edit one alone.

...
- **Pin the target explicitly on every ad-hoc `kubectl`/`gcloud`** — parallel sessions share the ambient context, and prod-guard denies unpinned mutating commands. Detail: kind-iteration.md § Target the cluster explicitly.

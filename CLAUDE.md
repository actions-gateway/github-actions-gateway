...
| Picking the next task, tracking progress, adding new items | `docs/queue/` (`make next-task`) — run `gh pr list` first and skip any item already covered by an open PR |

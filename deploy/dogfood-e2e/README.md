...
deploy/dogfood-e2e/
  ...
  overlays/
    ...
    kata/               # Kata micro-VM    — strong isolation (untrusted PRs)          ← arch validated (Q283)
```
...
- **kata:** planned ([Q283](../../docs/STATUS.md#Q283)). Note the measured runner
...
variant remains open under [Q283](../../docs/STATUS.md#Q283).
